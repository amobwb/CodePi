    ...
    public class EmployeeControllerTest
    {
        ...
        public void RuGett()
        {
            ...
            try
            {
                ...
                IWebElement enter = driver.FindElement(By.LinkText("Employee"));
                Thread.Sleep(1000);
                enter.Click();
        ...
        {
            //Find the element anchortag for the employee having name as 'Afshin'
            IWebElement anchorTag = (IWebElement)((IJavaScriptExecutor)driver).ExecuteScript("return $('a',$(\"td:contains('Afshin')\").parent())[0]");
            anchorTag.Click();
